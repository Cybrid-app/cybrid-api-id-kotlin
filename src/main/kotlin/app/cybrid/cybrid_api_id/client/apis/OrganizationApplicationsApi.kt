...
class OrganizationApplicationsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    suspend fun createOrganizationApplication(postOrganizationApplicationIdpModel: PostOrganizationApplicationIdpModel) : ApplicationWithSecretIdpModel = withContext(Dispatchers.IO) {
        val localVarResponse = createOrganizationApplicationWithHttpInfo(postOrganizationApplicationIdpModel = postOrganizationApplicationIdpModel)
    ...
    */
    ...
    suspend fun createOrganizationApplicationWithHttpInfo(postOrganizationApplicationIdpModel: PostOrganizationApplicationIdpModel) : ApiResponse<ApplicationWithSecretIdpModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = createOrganizationApplicationRequestConfig(postOrganizationApplicationIdpModel = postOrganizationApplicationIdpModel)

        return@withContext request<PostOrganizationApplicationIdpModel, ApplicationWithSecretIdpModel>(
            localVariableConfig
        )
    }

    /**
    * To obtain the request config of the operation createOrganizationApplication
    *
    * @param postOrganizationApplicationIdpModel  
    * @return RequestConfig
    */
    fun createOrganizationApplicationRequestConfig(postOrganizationApplicationIdpModel: PostOrganizationApplicationIdpModel) : RequestConfig<PostOrganizationApplicationIdpModel> {
        val localVariableBody = postOrganizationApplicationIdpModel
        ...
        return RequestConfig(
            ...
            path = "/api/organization_applications",
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listOrganizationApplications(page: kotlin.Int?, perPage: kotlin.Int?) : ApplicationListIdpModel = withContext(Dispatchers.IO) {
        val localVarResponse = listOrganizationApplicationsWithHttpInfo(page = page, perPage = perPage)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun listOrganizationApplicationsWithHttpInfo(page: kotlin.Int?, perPage: kotlin.Int?) : ApiResponse<ApplicationListIdpModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = listOrganizationApplicationsRequestConfig(page = page, perPage = perPage)
    ...
    /**
    * To obtain the request config of the operation listOrganizationApplications
    *
    * @param page The page index to retrieve. (optional, default to 0)
    * @param perPage The number of entities per page to return. (optional, default to 10)
    * @return RequestConfig
    */
    fun listOrganizationApplicationsRequestConfig(page: kotlin.Int?, perPage: kotlin.Int?) : RequestConfig<Unit> {
