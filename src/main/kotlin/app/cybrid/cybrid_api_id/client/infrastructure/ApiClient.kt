    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth = when (authName) {
                "BearerAuth" -> HttpBearerAuth("bearer")"oauth2" -> OAuth(OAuthFlow.application, "", "https://id.sandbox.cybrid.app/oauth/token", "organizations:write, organizations:read, organization_applications:execute, banks:write, banks:read, bank_applications:execute, users:read, users:execute, customers:write, customers:read")
