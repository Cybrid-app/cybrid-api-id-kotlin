...
data class ApplicationWithSecretIdpModel (
     ...
     * List of the scopes granted to the OAuth2 application.
     *
     * Values: organizationsColonRead,organizationsColonWrite,banksColonRead,banksColonWrite,banksColonExecute,customersColonRead,accountsColonRead,quotesColonRead,tradesColonRead,externalBankAccountsColonRead,workflowsColonRead,accountsColonExecute,customersColonWrite,customersColonExecute,pricesColonRead,quotesColonExecute,tradesColonExecute,rewardsColonExecute,rewardsColonRead,externalBankAccountsColonExecute,workflowsColonExecute
     */
