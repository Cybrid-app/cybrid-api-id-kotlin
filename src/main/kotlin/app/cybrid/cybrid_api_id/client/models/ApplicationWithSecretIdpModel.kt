...
import app.cybrid.cybrid_api_id.client.models.ApplicationWithSecretAllOfIdpModel
 ...
 * 
 *
 * @param name Name provided for the OAuth2 application.
 * @param clientId The OAuth2 application's client ID.
 * @param scopes List of the scopes granted to the OAuth2 application.
 * @param createdAt ISO8601 datetime the application was created at.
 * @param secret The OAuth2 application's secret.
 */

data class ApplicationWithSecretIdpModel (
    ...
    val scopes: kotlin.collections.List<ApplicationWithSecretIdpModel.Scopes>,
     ...
     * List of the scopes granted to the OAuth2 application.
     *
     * Values: organizationsColonRead,organizationsColonWrite,banksColonRead,banksColonWrite,banksColonExecute,customersColonRead,accountsColonRead,quotesColonRead,tradesColonRead,transfersColonRead,externalBankAccountsColonRead,workflowsColonRead,accountsColonExecute,customersColonWrite,customersColonExecute,pricesColonRead,quotesColonExecute,tradesColonExecute,transfersColonExecute,rewardsColonExecute,rewardsColonRead,externalBankAccountsColonExecute,workflowsColonExecute
     */
    enum class Scopes(val value: kotlin.String) {
        @SerializedName(value = "organizations:read") organizationsColonRead("organizations:read"),
        @SerializedName(value = "organizations:write") organizationsColonWrite("organizations:write"),
        @SerializedName(value = "banks:read") banksColonRead("banks:read"),
        @SerializedName(value = "banks:write") banksColonWrite("banks:write"),
        @SerializedName(value = "banks:execute") banksColonExecute("banks:execute"),
        ...
        @SerializedName(value = "transfers:read") transfersColonRead("transfers:read"),
        @SerializedName(value = "external_bank_accounts:read") externalBankAccountsColonRead("external_bank_accounts:read"),
        @SerializedName(value = "workflows:read") workflowsColonRead("workflows:read"),
        @SerializedName(value = "accounts:execute") accountsColonExecute("accounts:execute"),
        @SerializedName(value = "customers:write") customersColonWrite("customers:write"),
        @SerializedName(value = "customers:execute") customersColonExecute("customers:execute"),
        ...
        @SerializedName(value = "trades:execute") tradesColonExecute("trades:execute"),
        @SerializedName(value = "transfers:execute") transfersColonExecute("transfers:execute"),
        @SerializedName(value = "rewards:execute") rewardsColonExecute("rewards:execute"),
        @SerializedName(value = "rewards:read") rewardsColonRead("rewards:read"),
        @SerializedName(value = "external_bank_accounts:execute") externalBankAccountsColonExecute("external_bank_accounts:execute"),
        @SerializedName(value = "workflows:execute") workflowsColonExecute("workflows:execute");
    }
}
